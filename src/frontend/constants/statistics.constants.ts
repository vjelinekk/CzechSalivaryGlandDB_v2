...
export const CATEGORY_TITLES: Record<InferenceChiSquareCategories, string> = {
    [InferenceChiSquareCategories.histologicalTypes]: 'Histologický typ nádoru - možnosti k výběru',
    [InferenceChiSquareCategories.tClassification]: 'T klasifikace - možnosti k výběru',
    [InferenceChiSquareCategories.nClassification]: 'N klasifikace - možnosti k výběru',
    [InferenceChiSquareCategories.mClassification]: 'M klasifikace - možnosti k výběru',
    [InferenceChiSquareCategories.persistence]: 'Perzistence - možnosti k výběru',
