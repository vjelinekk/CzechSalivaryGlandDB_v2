export enum Components {
    ...
    addPatientBenign = 'add-patient-benign',
    addPatientMalignant = 'add-patient-malignant',
    studiesList = 'studies-list',
    addStudy = 'add-study',
    parotidGlandForm = 'parotid-gland-form',
    parotidBenignGlandForm = 'parotid-benign-gland-form',
    sublingualGlandForm = 'sublingual-gland-form',
    submandibularGlandForm = 'submandibular-gland-form',
    submandibularBenignGlandForm = 'submandibular-benign-gland-form',
    study = 'study',
