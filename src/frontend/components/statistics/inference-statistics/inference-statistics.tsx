...
interface InferenceStatisticsProps {}

const InferenceStatistics: React.FC<InferenceStatisticsProps> = () => {
    const [selectedTest, setSelectedTest] = useState<StatisticalTest>('chi-square');
            ...
            <Paper elevation={3} sx={{ p: 3, mt: 3 }}>
                ...
                <Box sx={{ mt: 3, mb: 4 }}>
                    <FormControl component="fieldset">
                        <FormLabel component="legend">Zvolte statistický test:</FormLabel>
                        <RadioGroup
                            row
                            value={selectedTest}
                ...
                <Box sx={{ mt: 3 }}>
                    ...
                    {selectedTest === 'mann-whitney' && (
                        <Typography variant="h6">Mann-Whitney U test - implementace bude přidána</Typography>
                    )}
                </Box>
            </Paper>
        </Container>
