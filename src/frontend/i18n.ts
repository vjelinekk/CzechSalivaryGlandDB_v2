...
const loadTranslations = async () => {
  ...
  const enTranslation = await window.fs.loadJson('public/locales/translation-en.json');
  const csTranslation = await window.fs.loadJson('public/locales/translation-cs.json');
  // const skTranslation = await window.fs.loadJson('public/locales/translation-sk.json');
  ...
  const csFormTranslation = await window.fs.loadJson('public/locales/form-translation-cs.json');
  const enFormTranslation = await window.fs.loadJson('public/locales/form-translation-en.json');
  // const skFormTranslation = await window.fs.loadJson('public/locales/form-translation-sk.json');
