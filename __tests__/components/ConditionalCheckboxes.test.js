        ...
        await act(async () => {
            render(
                <ConditionalCheckboxes 
                    ...
                    data={null}
                    children={[
                        <ConditionalCheckboxOption key={1} disabled={false} checked={false} setChecked={jest.fn()} label='Test1' />,
                        <ConditionalCheckboxOption key={2} disabled={false} checked={false} setChecked={jest.fn()} label='Test2' />
                    ]}
                />
            );
        });
