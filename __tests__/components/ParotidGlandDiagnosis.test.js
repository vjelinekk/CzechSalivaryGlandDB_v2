...
describe('ParotidGlandDiagnosis', () => {
  ...
  test('renders section headings and various input components', () => {
    render(<ParotidGlandDiagnosis formData={formData} setFormData={setFormData} disabled={false} />);
  ...
  test('disables input components when disabled prop is true', () => {
    render(<ParotidGlandDiagnosis formData={formData} setFormData={setFormData} disabled={true} />);
