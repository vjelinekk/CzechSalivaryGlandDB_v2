...
describe('EditResult component', () => {
    ...
    test('renders edit error message', async () => {
        ...
        const editErrorMessage = await screen.findByText('Nastala chyba při ukládání změny');
    ...
    test('does not render anything if editSaved is false', () => {
        ...
        const editErrorMessage = screen.queryByText('Nastala chyba při ukládání změny');
