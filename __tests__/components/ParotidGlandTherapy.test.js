...
describe('ParotidGlandTherapy', () => {
  ...
  test('renders section headings and various input components', () => {
    render(<ParotidGlandTherapy formData={formData} setFormData={setFormData} disabled={false} />);
  ...
  test('disables input components when disabled prop is true', () => {
    render(<ParotidGlandTherapy formData={formData} setFormData={setFormData} disabled={true} />);
